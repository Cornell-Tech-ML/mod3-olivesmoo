...
class Tensor:
    ...
    def requires_grad(self) -> bool:
        """Checks if there is a history for this Tensor"""
    ...
    def all(self, dim: Optional[int] = None) -> Tensor:
        ...
        if dim is None:  # cover the entire tensor
            ...
            return All.apply(self, self._ensure_tensor(dim))  # type: ignore

    def is_close(self, a: Tensor) -> Tensor:
        """Checks if values in 2 tensors are close"""
        return IsClose.apply(self, a)
    ...
    def mean(self, dim: Optional[int] = None) -> Tensor:
        ...
        if dim is not None:  # average over entire tensor
